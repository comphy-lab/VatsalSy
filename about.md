...
<script>
  ...
  if (window.location.pathname === '/about/' || window.location.pathname === '/about') {
    ...
    window.location.replace("{{ site.baseurl }}/#about");
  }
</script>
...
<div class="email-container">
  ...
  <div class="email-actions">
    ...
    <button class="copy-btn" data-text="vatsal.sanjay@comphy-lab.org" aria-label="Copy email address vatsal.sanjay@comphy-lab.org">
